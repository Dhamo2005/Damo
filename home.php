        ...
        <div class="card card-xxl-stretch">
            ...
            <div class="card-body p-0" style="position: relative;">
                ...
                <div class="mixed-widget-2-chart card-rounded-bottom bg-danger" data-kt-color="danger" style="height: 200px; min-height: 200px;">
                    <div id="kt_apexcharts_3" class="apexcharts-canvas apexcharts-theme-dark" style="width: 100%!important;">
                ...
                <div class="card-p mt-n20 position-relative">
                    ...
                    <div class="row g-0">
                        <!--begin::Col-->
                        <div class="d-shadow col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                            ...
                            <!--end::Svg Icon-->
                            <a href="upload.php" class="text-warning fw-bold fs-6">Upload</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="d-shadow col bg-light-primary px-6 py-8 rounded-2 mb-7">
                            <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                            <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <!--end::Svg Icon-->
                            <a href="settings.php" class="text-primary fw-bold fs-6">My Profile</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row g-0">
                        <!--begin::Col-->
                        <div class="d-shadow col bg-light-danger px-6 py-8 rounded-2 me-7">
                            ...
                            <!--end::Svg Icon-->
                            <a href="explore.php" class="text-danger fw-bold fs-6 mt-2">Explore</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="d-shadow col bg-light-success px-6 py-8 rounded-2">
                            ...
                            <!--end::Svg Icon-->
                            <a href="#" class="text-success fw-bold fs-6 mt-2">Notifications</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
