...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative noselect" data-kt-sticky-landing-header="on" data-kt-scrolltop="on">
    ...
    <div class="d-flex flex-column flex-root">
        <div class="mb-0" id="home">
            <div style="background: linear-gradient(136deg, #0a0a54, #004080);" class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center flex-equal"><button class="btn btn-icon btn-active-color-primary me-3 d-flex d-lg-none" id="kt_landing_menu_toggle"><span class="svg-icon svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        ...
                                        </svg></span></button><a href="landing.html"><img alt="Logo" src="assets/media/logos/logo-landing.svg" class="logo-default h-25px h-lg-30px"><img alt="Logo" src="assets/media/logos/logo-landing-dark.svg" class="logo-sticky h-20px h-lg-25px"></a></div>
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">An Outstanding Solutions For Students &amp; Teachers &amp; Educators</h1><a href="<?php if (!isset($_SESSION['email'])) {
                                                                                                                                                                            echo "pages/sign-in.php";
                                                                                                                                                                        } else {
                                                                                                                                                                            echo "home.php";
            ...
            <div class="landing-curve landing-dark-color mb-10 mb-lg-20"><svg viewBox="15 12 1470 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <pathd="m0 11c3.93573="" 11.3356="" 7.85984="" 11.6689="" 11.7725="" 12h1488.16c1492.1="" 1496.04="" 1500="" 11v12h1488.16c913.668="" 60.3476="" 586.282="" 60.6117="" 12h0v11z"fill="currentColor"></pathd="m0>
                </svg></div>
        </div>
        ...
        <div class="mt-sm-n10">
            ...
            <div class="pb-15 pt-18 landing-dark-bg" style=" background: linear-gradient(136deg, #050533, #084480);">
                <div class="container">
                    ...
                    <div class="fs-2 fw-bold text-muted text-center"><a href="account/security.html" class="link-primary fs-4 fw-bolder">Dhamodharan,</a><span class="fs-4 px-2 fw-bolder text-gray-600">Damo Softwares CEO</span></div>
                </div>
            </div>
    ...
    <div class="mb-0">
        ...
        <div class="landing-dark-bg pt-20" style="background: linear-gradient(358deg, #0a0a54, #0a3663);">
            <div class="container">
                <div class="row py-10 py-lg-20">
                    <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                        ...
                        <div class="rounded landing-dark-border p-9">
                            <h2 class="text-white">Do You Need Website For Your Busineess?</h2><span class="fw-normal fs-4 text-gray-700">Use Our Custom Development Service.<a href="pages/profile/overview.html" class="text-white opacity-50 text-hover-primary">Click here!</a></span>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="d-flex fw-bold flex-column ms-lg-20">
                                <h4 class="fw-bolder text-gray-400 mb-6">Stay Connected</h4><a href="#" class="mb-6"><img src="assets/media/svg/brand-logos/facebook-4.svg" class="h-20px me-2" alt=""><span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Facebook</span></a><a href="https://github.com/Dhamo2005/" class="mb-6"><img src="assets/media/svg/brand-logos/github.svg" class="h-20px me-2" alt=""><span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Github</span></a><a href="#" class="mb-6"><img src="assets/media/svg/brand-logos/twitter.svg" class="h-20px me-2" alt=""><span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Twitter</span></a><a href="#" class="mb-6"><img src="assets/media/svg/brand-logos/dribbble-icon-1.svg" class="h-20px me-2" alt=""><span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Dribbble</span></a><a href="#" class="mb-6"><img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="h-20px me-2" alt="">
                                    <spanclass="text-white opacity-50="" text-hover-primary="" fs-5="" mb-6"="">Instagram</spanclass="text-white>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                    <div class="d-flex align-items-center order-2 order-md-1"><a href="landing.html"><img alt="Logo" src="assets/media/logos/logo-landing.svg" class="h-15px h-md-20px"></a><span class="ms-4 ms-md-10 mx-4 fs-6 fw-bold text-gray-600 pt-1">©2021 Damo Softwares.</span></div>
    ...
    <script src="assets/js/custom/pages/company/pricing.js"></script><noscript>
        <iframesrc="https: //www.googletagmanager.com/ns.html?id=GTM-5FS8GGP" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript><svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;">
