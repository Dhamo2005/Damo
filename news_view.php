            ...
            <div class="d-flex flex-column flex-xl-row">
                <div class="flex-lg-row-fluid me-xl-15">
                    <div class="mb-17">
                        ...
                        <div class="d-flex flex-center">
                            <a class="mx-4" id="share_facebook"><img src="assets/media/svg/brand-logos/facebook-4.svg" class="h-20px my-2" alt="Share On Facebook"></a>
                            <a class="mx-4" id="share_insta"><img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="h-20px my-2" alt=""></a>
                            <a class="mx-4" id="share_twitter"><img src="assets/media/svg/brand-logos/twitter.svg" class="h-20px my-2" alt=""></a>
                        </div>
                        <script>
                            function sharer(link, url) {
                ...
                <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                    <div class="m-0">
                        ...
                        <?php
                        $sql = "SELECT id,title,description, date, views FROM `news` WHERE NOT news.id = '$news_id' ORDER BY date DESC";
                        $res = $con->query($sql);
                        while ($row = $res->fetch_assoc()) {
                        ?>
                            <div class="d-flex flex-stack mb-7">
                                <div class="w-100 m-0"><a class="news_title text-dark fw-bolder text-hover-primary fs-6" href="news_view.php?news=<?php echo base64_encode(base64_encode($row['id'])); ?>">
                                        <?php
                                        echo limitxt($row['title'], 250, 'Read More');
                                        ?>
                                    </a>
